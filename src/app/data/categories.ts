...
export const categories: Category[] = [
  ...
  { id: 'hygiene', name: 'Higiene', icon: Sparkles, color: '#14B8A6', type: 'expense' },
  { id: 'gym', name: 'Gym', icon: Dumbbell, color: '#84CC16', type: 'expense' },
  ...
  { id: 'travel', name: 'Viajes', icon: Plane, color: '#0EA5E9', type: 'expense' },
